        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-2">
            <h2 className="text-5xl font-black">
              Try <span className="bg-gradient-to-r from-[#9945FF] to-[#14F195] text-transparent bg-clip-text">spl402</span> on Mainnet
            </h2>
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="text-lg text-gray-400">
                Powered by <span className="font-semibold bg-gradient-to-r from-[#9945FF] to-[#14F195] text-transparent bg-clip-text">SOLANA</span>
              </div>
            </div>
          </div>
        </footer>
